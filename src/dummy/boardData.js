module.exports =[
    {
        ...
        content:'에페롤 스프릿츠는 북 이탈리아 태생으로 2016에 이르러서 인기를 얻게되었습니다. 스파클링 와인, 에페롤, 소다수가 3:2:1의 비율로 어우러진 음료지요.'
    },
    {
        "nickname": "5-blue",
        createAt : '2023-02-15',
        ...
        content:'에이비에이션은 "혼합음료를 위한 레시피" 란 1916년 휴고 엔슬린이 작성한 책에 처음 등장했습니다. 드링크 인터내셔널이 조사한 바 15%의 매장에서 에이비에이션은 상위 10위안에 드는 음료라고 한다. 진과 마라스키노 리큐어, 크렘 드 바이올렛, 그리고 레몬 주스가 들어갑니다.'
    },
    {
        "nickname": "10xcxcxc",
        createAt : '2023-01-07',
        ...
        content:'진 피즈의 인기는 나날이 상승하는군요! 2015년에는 50위 안에 들지 못했습니다만, 지금은 이 진, 레몬, 설탕 그리고 소다를 섞은 음료는 세계에서 25번째로 많이 주문되는 칵테일이 되었습니다.'
    },
    {
        "nickname": "1004papa",
        createAt : '2023-01-28',
        ...
        content:'트로피컬한 칵테일인 마이 타이는 2015년에 17위의 위치에서 현재 4계단 하락했습니다. 만들기 위해서는 골든럼 두 파트, 오렌지 퀴라소 리큐어 한 파트, 라임 한 파트, 디사론노 리큐어 반파트, 얼음을 추가한 단미 시럽 반파트를 쉐이크 한 후 여과기를 거쳐 만들지요.'
    },
    {
        "nickname": "5-blue",
        createAt : '2023-01-29',
        ...
        content:'마가리타는 세계에서 7번째로 많이 주문된 칵테일로서의 자리를 지켰습니다. 데낄라, 트리플 섹 그리고 라임 혹은 레몬즙을 넣어 만들어지는 이 음료는 종종 잔의 테두리에 소금이나 설탕을 묻혀 제공됩니다.'
    },
    {
        "nickname": "KHH123",
        createAt : '2023-02-25',
        ...
        title:'이건 제가 여기 최초일듯',
        content:'다이커리는 2015년 6위로에서 2016년 4위로 두 계단 상승했습니다. 조사된 바의 10%에서 가장 많이 주문된 음료입니다. 1잔을 만들기 위해서는 데낄라 1.5온스, 심플 시럽 1.5온스, 그리고 라임쥬스 1온스를 사용하면 됩니다. 여기에 딸기를 추가하면 다른 풍미를 낼 수 있습니다.'
    },
    {
        "nickname": "99kwhan",
        createAt : '2023-02-13',
        ...
        content:'칵테일계의 클래식, 올드패션드는 2015년에 이어 올해도 가장 많이 팔리는 칵테일로 자리 잡았습니다. 투표에 응한 바 중 무려 75%에서 가장 많이 주문된 칵테일 10위 안에 들었습니다. 올드패션드는 비터스와 설탕을 섞고 브랜디나 위스키를 따른 다음 그 위에 감귤류 과일 껍질을 살짝 짜서 과즙을 첨가하여 만듭니다.'
    },
    {
        "nickname": "1004papa",
        createAt : '2023-02-05',
    ...
    },
    {
        ...
        title:'깔루아밀크를 아십니까...!!!!!!!!!',
        content:'깔루아 밀크는 커피 맛이 나는 깔루아 보드카에 우유를 섞어 만든 칵테일. 평소 커피를 즐기는 사람이라면 부담 없이 도전해 볼 수 있는 칵테일이다. 깔루아 리큐어 자체는 20도 정도의 꽤 높은 도수를 갖고 있지만 우유를 섞으면 도수는 낮아진다. 달달한 커피의 향기와 살짝 쓴맛이 조화롭고 우유의 부드럽고 깔끔한 목넘김으로, 특히 한국에서 사랑받는 칵테일. 술을 정말 못해도 우유가 있으니 안심하고 마셔봐도 좋다.        '
    },
]