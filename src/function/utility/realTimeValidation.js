...
export const realTimeValidation = (member) => {
  ...
  if (members.filter((x) => x.email === member.email).length !== 0) {
    danger = { ...danger, email: "이미 사용중인 이메일입니다." };
  }
